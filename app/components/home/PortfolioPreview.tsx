...
// ✅ Project type including id & timestamps
interface Project {
  _id: string;
  slug: string;
  title: string;
            ...
            .map((project, i) => {
              ...
              return (
                <motion.div
                  ...
                  viewport={{ once: true }}
                  className="group relative bg-white hover:border-gold dark:bg-[#1A1A1A] rounded-xl shadow-md overflow-hidden border border-gray-200 dark:border-gray-700"
                >
                  {/* Type badge */}
                  {project.type && (
                    <span
