...
const DentistRegistrationForm: React.FC = () => {
    ...
    if (type === "checkbox") {
      ...
      if (files && files[0]) {
        ...
        if (file.size > 600 * 1024) {
          alert(
            `File size must be less than 600KB. Selected file is ${(
              file.size / 1024
            ).toFixed(1)}KB`
          );
          return;
  ...
  useEffect(() => {
    const handleClick = (e: MouseEvent) => {
      if (
        problemsRef.current &&
        !problemsRef.current.contains(e.target as Node)
      ) {
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-[#eaf2fb] relative p-4">
      ...
      >
        <h2 className="text-3xl font-extrabold text-[#2C73D2] mb-2 text-center">
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
          <input
            ...
            placeholder="Name"
            className="rounded-xl px-5 py-3 border border-gray-200 focus:border-[#2C73D2] outline-none"
            required
          />
          <input
            name="phone"
        ...
        <div className="flex flex-col gap-1 md:col-span-2" ref={problemsRef}>
          <label className="text-sm font-semibold text-[#2C73D2]">
            Problems You Treat (Select Multiple)
          </label>
          <div className="relative">
            ...
            >
              ...
              {form.problems.map((problem) => (
                <span
                  key={problem}
                  className="flex items-center gap-1 bg-[#eaf2fb] text-[#2C73D2] font-medium px-2 py-1 rounded-md"
                >
                  {problem}
                  <button
                    type="button"
              ...
              <input
                ...
                placeholder={
                  form.problems.length === 0 ? "Select problems..." : ""
                }
              ...
              <div className="absolute z-10 w-full mt-2 overflow-y-auto bg-white border border-gray-200 shadow-lg rounded-xl max-h-60">
                <ul className="p-1">
                  {DENTAL_PROBLEMS.filter(
                    ...
                    <li
                      key={problem}
                      className="p-2 cursor-pointer rounded-md hover:bg-[#eaf2fb]"
        ...
        <div className="md:col-span-2">
          <h3 className="text-xl font-bold text-[#2C73D2] mb-4 border-b pb-2">
            Graduation Details
          </h3>
        ...
        <div className="md:col-span-2">
          <input
            ...
            className="w-full rounded-xl px-5 py-3 border border-gray-200 focus:border-[#2C73D2] outline-none"
          />
        </div>
        ...
        <div className="md:col-span-2">
          <div className="flex items-center gap-4">
            ...
            <label
              htmlFor="hasClinic"
              className="text-lg font-semibold text-[#2C73D2]"
            >
              I have a clinic
            </label>
          </div>
        ...
        {form.hasClinic && (
          <div className="grid grid-cols-1 gap-6 p-6 border md:col-span-2 md:grid-cols-2 bg-gray-50 rounded-xl">
            ...
            <input
              ...
              className="md:col-span-2 rounded-xl px-5 py-3 border border-gray-200 focus:border-[#2C73D2] outline-none"
            />
            <input
              name="clinicInsta"
              value={form.clinicInsta}
              onChange={handleChange}
        ...
        <div className="flex items-center gap-2 md:col-span-2">
          <input
            ...
            className="w-5 h-5 rounded"
          />
          <label htmlFor="agreeDisclaimer" className="text-sm">
        ...
        <button
          type="submit"
          className="w-full py-4 rounded-xl bg-gradient-to-r from-[#2C73D2] to-[#2056AE] text-white font-bold text-xl"
          disabled={loading}
        >
