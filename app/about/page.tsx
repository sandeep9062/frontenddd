        ...
        >
          ...
          <div>
            ...
            <p className="text-base md:text-lg text-gray-700 dark:text-gray-300 mb-4 leading-relaxed">
              At <strong>Maldonite</strong>, we craft software that
              scales, performs, and delivers results. Our goal is to empower
              businesses through strategic, data-driven digital products.
            </p>
